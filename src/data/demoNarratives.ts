...
export const DEMO_NARRATIVES: DemoNarrative[] = [
  {
    ...
    characters: [
      ...
      character("kelly", "凯利"),
      character("coachman", "马车夫"),
    ],
    events: [
      { id: "f1", order: 1, description: "安东尼与儿子谈论金钱", location: "洛克沃尔书房", characters: ["anthony", "richard"], character_importance: { anthony: 0.5, richard: 0.5 }, importance: "medium", evidence: "" },
      { id: "f2", order: 2, description: "理查德说出求爱的难题", location: "洛克沃尔书房", characters: ["richard", "anthony"], character_importance: { richard: 0.5833, anthony: 0.4167 }, importance: "high", evidence: "" },
      { id: "f3", order: 3, description: "埃伦姑妈交出母亲的戒指", location: "埃伦姑妈家", characters: ["ellen", "richard"], character_importance: { ellen: 0.625, richard: 0.375 }, importance: "medium", evidence: "" },
      { id: "f4", order: 4, description: "理查德在车站接到兰特里", location: "中央火车站", characters: ["richard", "lantry", "coachman"], character_importance: { richard: 0.4545, lantry: 0.2727, coachman: 0.2728 }, importance: "medium", evidence: "" },
      { id: "f5", order: 5, description: "马车陷入预先安排的交通阻塞", location: "第三十四号街", characters: ["richard", "lantry", "anthony", "kelly", "coachman"], character_importance: { richard: 0.2593, lantry: 0.1852, anthony: 0.1111, kelly: 0.1852, coachman: 0.2592 }, importance: "high", evidence: "" },
      { id: "f6", order: 6, description: "理查德向兰特里表白并订婚", location: "第三十四号街", characters: ["richard", "lantry"], character_importance: { richard: 0.5, lantry: 0.5 }, importance: "high", evidence: "" },
      { id: "f7", order: 7, description: "凯利揭示交通阻塞的安排", location: "洛克沃尔书房", characters: ["kelly", "anthony"], character_importance: { kelly: 0.5833, anthony: 0.4167 }, importance: "medium", evidence: "" },
    ],
    relations: [
  ...
  },
  {
    ...
    characters: [
      ...
      character("black_man", "黑人男子"),
      character("blonde_woman", "金发女子"),
    ],
    events: [
      { id: "t1", order: 1, description: "托宾因卡蒂失踪而郁郁寡欢", location: "康奈岛", characters: ["tobin", "john", "katie"], character_importance: { tobin: 0.4737, john: 0.2632, katie: 0.2631 }, importance: "medium", evidence: "" },
      { id: "t2", order: 2, description: "佐佐夫人预言麻烦与钩鼻贵人", location: "康奈岛", characters: ["tobin", "zaza", "john"], character_importance: { tobin: 0.4118, zaza: 0.4118, john: 0.1764 }, importance: "high", evidence: "" },
      { id: "t3", order: 3, description: "托宾在码头冲突并丢失零钱", location: "康奈岛", characters: ["tobin", "john", "black_man"], character_importance: { tobin: 0.4118, john: 0.2941, black_man: 0.2941 }, importance: "medium", evidence: "" },
      { id: "t4", order: 4, description: "渡船上的意外让托宾确信预言应验", location: "回程渡船", characters: ["tobin", "john", "blonde_woman"], character_importance: { tobin: 0.5294, john: 0.2941, blonde_woman: 0.1765 }, importance: "high", evidence: "" },
      { id: "t5", order: 5, description: "托宾找到钩鼻的弗里登豪森曼", location: "第二十二街", characters: ["tobin", "john", "frieden"], character_importance: { tobin: 0.3684, john: 0.2632, frieden: 0.3684 }, importance: "high", evidence: "" },
      { id: "t6", order: 6, description: "三人在酒吧讨论预言与文学", location: "第二十二街", characters: ["tobin", "john", "frieden"], character_importance: { tobin: 0.3333, john: 0.2381, frieden: 0.4286 }, importance: "medium", evidence: "" },
      { id: "t7", order: 7, description: "弗里登豪森曼邀请两人回家吃夜宵", location: "弗里登豪森曼家", characters: ["tobin", "john", "frieden"], character_importance: { tobin: 0.2941, john: 0.2941, frieden: 0.4118 }, importance: "medium", evidence: "" },
      { id: "t8", order: 8, description: "帮厨女工正是失踪的卡蒂·玛霍纳", location: "弗里登豪森曼家", characters: ["tobin", "john", "katie", "frieden"], character_importance: { tobin: 0.1364, john: 0.1364, katie: 0.4091, frieden: 0.3181 }, importance: "high", evidence: "" },
    ],
    relations: [
  ...
  },
  {
    ...
    events: [
      ...
      { id: "s2", order: 2, description: "玛丽安在雪地滑倒扭伤脚踝", location: "百老汇街角", characters: ["marian", "chandler"], character_importance: { marian: 0.625, chandler: 0.375 }, importance: "medium", evidence: "" },
      { id: "s3", order: 3, description: "钱德勒邀请朴素的玛丽安共进晚餐", location: "百老汇街角", characters: ["chandler", "marian"], character_importance: { chandler: 0.5, marian: 0.5 }, importance: "high", evidence: "" },
      ...
      { id: "s5", order: 5, description: "钱德勒吹嘘虚构的上流生活", location: "百老汇饭馆", characters: ["chandler", "marian"], character_importance: { chandler: 0.7, marian: 0.3 }, importance: "high", evidence: "" },
      { id: "s6", order: 6, description: "钱德勒告别后回到寒冷卧室后悔", location: "寄宿舍卧室", characters: ["chandler", "marian"], character_importance: { chandler: 0.7, marian: 0.3 }, importance: "medium", evidence: "" },
      { id: "s7", order: 7, description: "玛丽安回到五马路豪宅显露真实身份", location: "玛丽安家", characters: ["marian", "sister", "maid"], character_importance: { marian: 0.4667, sister: 0.3333, maid: 0.2 }, importance: "high", evidence: "" },
      { id: "s8", order: 8, description: "玛丽安说出理想伴侣却否定钱德勒的伪装", location: "玛丽安家", characters: ["marian", "sister", "chandler"], character_importance: { marian: 0.5385, sister: 0.2308, chandler: 0.2307 }, importance: "high", evidence: "" },
    ],
    relations: [
  ...
  },
  {
    ...
    events: [
      { id: "b1", order: 1, description: "鲍格尔饭馆与两位女侍者登场", location: "八马路·鲍格尔饭馆", characters: ["bogel", "aileen", "tildy"], character_importance: { bogel: 0.3333, aileen: 0.3333, tildy: 0.3334 }, importance: "medium", evidence: "一个女侍者名叫爱玲。另一个女侍者的名字叫做蒂尔苔。" },
      { id: "b2", order: 2, description: "爱玲备受追捧，蒂尔苔无人问津却仍支持朋友", location: "鲍格尔饭馆店堂", characters: ["aileen", "tildy", "daredevil"], character_importance: { aileen: 0.4737, tildy: 0.3684, daredevil: 0.1579 }, importance: "medium", evidence: "她是爱玲的朋友；她乐于看到爱玲统治男人的心。" },
      { id: "b3", order: 3, description: "“冒失鬼”尾随爱玲并打伤她的眼睛", location: "二十三街至八马路", characters: ["aileen", "daredevil", "tildy"], character_importance: { aileen: 0.4667, daredevil: 0.3333, tildy: 0.2 }, importance: "high", evidence: "我结结实实地给了他一个耳刮子。他还手，把我眼睛打坏了。" },
      { id: "b4", order: 4, description: "醉酒的西德斯突然搂住并亲吻蒂尔苔", location: "鲍格尔饭馆店堂", characters: ["tildy", "seiders", "aileen"], character_importance: { tildy: 0.4118, seiders: 0.4118, aileen: 0.1764 }, importance: "high", evidence: "西德斯先生吃完了他的柔鱼，站起身来，搂住蒂尔苔的腰，冒冒失失地大声吻了她一下。" },
      { id: "b5", order: 5, description: "蒂尔苔宣告受吻，获加薪并成为众人打趣的焦点", location: "鲍格尔账桌与店堂", characters: ["tildy", "aileen", "bogel", "seiders"], character_importance: { tildy: 0.45, aileen: 0.15, bogel: 0.25, seiders: 0.15 }, importance: "high", evidence: "下星期起，我加你一块钱薪水。" },
      { id: "b6", order: 6, description: "西德斯缺席两天，蒂尔苔精心打扮并幻想热恋", location: "鲍格尔饭馆店堂", characters: ["tildy", "seiders", "aileen"], character_importance: { tildy: 0.6, seiders: 0.2, aileen: 0.2 }, importance: "medium", evidence: "她买了缎带，把自己的头发像爱玲那样打扮起来，并且把腰身束紧了两英寸。" },
      { id: "b7", order: 7, description: "西德斯回来道歉，坦言亲吻只是醉酒失态", location: "鲍格尔饭馆后部", characters: ["seiders", "tildy", "aileen"], character_importance: { seiders: 0.5294, tildy: 0.2941, aileen: 0.1765 }, importance: "high", evidence: "我那晚喝得糊里糊涂，不然我绝对不会做出那种事来的。" },
      { id: "b8", order: 8, description: "蒂尔苔梦想破灭，爱玲在屏风后温柔安慰她", location: "饭馆屏风后", characters: ["tildy", "aileen", "seiders"], character_importance: { tildy: 0.4737, aileen: 0.3684, seiders: 0.1579 }, importance: "high", evidence: "爱玲的胳臂搂住了她；蒂尔苔的红通通的手在牛油碟子中间摸索了一会儿，握住了她朋友的温暖的手。" },
    ],
    relations: [
